...
FINEDATA = []
countries = ["Usa", "New%20Zealand", "France", "Argentina", "Germany", "Italy", "Australia"]
colors = ["red", "white"]

colors.each do |color|
  countries.each do |country|
    wineData = RestClient.get("https://private-amnesiac-61d3e-globalwinescore.apiary-proxy.com/globalwinescores/latest/?color=#{color}&limit=1000&country=#{country}",
                              { :Authorization => "Token fedc2e80db0640426d5792f6b7c56f2c782ea233" })
